...
print("Simulated probability of rolling 11:",
      prob_sum(rolls_3, 11))
print("Simulated probability of rolling 12:",
      prob_sum(rolls_3, 12))

# simulate 300 dice rolls
rolls_300 = rng.integers(1, 6, (sims, 300), endpoint=True)
print("\nResults with 300 dice")
print("Simulated probability of rolls summing to 1111:",
      prob_sum(rolls_300, 1111))
print("Simulated probability of rolls summing to 1112:",
      prob_sum(rolls_300, 1112))
